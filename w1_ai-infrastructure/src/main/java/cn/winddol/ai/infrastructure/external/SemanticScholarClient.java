...
import cn.winddol.ai.paper.domain.S2PaperResponse;
...
@Component
@Slf4j
public class SemanticScholarClient implements ISemanticScholar {
     ...
     */
    @Override
    public S2PaperData searchPaper(String rawReference) {
